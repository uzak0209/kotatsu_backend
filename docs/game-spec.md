...
- Networking: UDP-based realtime transport (32ms tick target)
...
- Client sends:
  - reliable parameter changes on reliable UDP packets
  - unreliable position updates on UDP datagrams
